  ...
  render() {
    return (
      <div className="animated fadeIn">
        ...
        <Row>
          <Col xs={12} sm={6} md={3}>
            <Widget03 dataBox={() => ({ variant: 'facebook', followers: '66k', feeds: '459' })} >
          ...
          <Col xs={12} sm={6} md={3}>
            <Widget03 dataBox={() => ({ variant: 'twitter', followers: '1.5k', tweets: '1.792' })} >
              <div className="chart-wrapper">
          ...
          <Col xs={12} sm={6} md={3}>
            <Widget03 dataBox={() => ({ variant: 'linkedin', contacts: '45+', feeds: '25' })} >
              <div className="chart-wrapper">
