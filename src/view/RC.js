    ...
    return (
        <Card hoverable style={{backgroundColor: '#00b6ba'}}>
            ...
            <Form.Item
                ...
                hasFeedback
            >
                <Select placeholder={languageName[2].value} type="text" mode="inline" style={{ width: '100%' }} onChange={handleChange}>
                {children}
                </Select>
            </Form.Item>
            ...
            <Form.Item
                ...
                hasFeedback
            >
                 <Select type="text" mode="inline" style={{ width: '100%' }} placeholder={languageName[3].value} onChange={handleChange}>
                {children}
                </Select>
            </Form.Item>
            <Card hoverable >
            ...
            <Modal title={<p style={{fontSize: 20, color: '#00b6ba'}}>{resultlang[1].value}</p>} visible={active} onCancel={() => setActive(false)} onOk={() => setActive(false)} footer={null} width={1000}>
            <Form
            {...formItemLayout}
              name="register"
              scrollToFirstError
