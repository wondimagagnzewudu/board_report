...
var data2 = {
  label: 'Diredewa',
  values: [{ x: 'Spoiled ballot ', y: 10 }, { x: 'voted', y: 3 },]
};
class Plots extends React.Component {
    ...
    if (grouped) {
      ...
      return (
        <GridList
          ...
          style={{
            width: { width },
            height: this.props.gridList_height,
            overflowY: this.props.gridLis_overflowY,
          }}>
          {charts}
        </GridList>
      )
  ...
  selectedChart = nameChart => {
    ...
    } else if (nameChart === 'Scatter Plot') {
      // scatter plot
      return (data, width, colorScale) => (
        <ScatterPlot
          data={data}
    ...
    return (
      <div>
        {/* <div className="plot-menu">
          <table className="plot-form-table">
            <tbody>
              <tr>
        ...
        <div id="plot" className="plot-view">
          ...
          <h4>  Dire Dawa Administration </h4>
        </div>
      </div>
    )
  }
